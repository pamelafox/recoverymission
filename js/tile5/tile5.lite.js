    ...
    var TouchHelper =  function(params) {
        ...
        */
        ...
        var doubleTap = false,
            ...
            aggressiveCapture = true, // typeof FlashCanvas !== 'undefined',
...
T5.TimeLord = (function() {
    ...
    */   
    function parse8601Duration(input) {
        ...
        GT.Log.info("duration has " + durationParts.length + " parts");
        return new module.Duration(days, seconds);
    } // parse8601Duration
